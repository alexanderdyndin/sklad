...
@Entity(tableName = "arrive_invoice_composition", foreignKeys = [ForeignKey(entity = Product::class, parentColumns = arrayOf("articul"), childColumns = arrayOf("articul")),
    ForeignKey(entity = Arrival::class, parentColumns = arrayOf("number_invoice"), childColumns = arrayOf("number_invoice"))])
data class ArriveInvoiceComposition(
